...
use MainBundle\Entity\Following;
...
class FollowingController extends Controller {
    ...
    public function followAction(Request $request) {
        ...
        if ($flush == null) {
            ...
            $status = "Ahora sigues a este usuario";
        } else {
            $status = "Ya sigues a este usuario";
        }
    ...
    public function unfollowAction(Request $request) {
        ...
        if ($flush == null) {
            ...
            $status = "Ha ocurrido un error, intentelo de nuevo";
        }
    ...
    public function followingAction(Request $request, $nickname = null){
        ...
        $user_id = $user->getId();
        $dql = "SELECT f FROM MainBundle:Following f WHERE f.user = $user_id ORDER BY f.id DESC";
    ...
    public function followedAction(Request $request, $nickname = null){
        ...
        $user_id = $user->getId();
        $dql = "SELECT f FROM MainBundle:Following f WHERE f.followed = $user_id ORDER BY f.id DESC";
        $query = $em->createQuery($dql);
